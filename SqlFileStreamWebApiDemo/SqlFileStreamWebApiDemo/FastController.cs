...
namespace SqlFileStreamWebApiDemo.Controllers
{
    public class FastController : ApiController
    {
        ...
        public HttpResponseMessage GetResult()
        {
            ...
            //var id = new Guid("1277453e-6894-4c57-95b3-8498b316d43a");//unzipped
            var id = new Guid("b65f0a7d-4f1d-4706-98ad-5a5e0c1823b6");//zippped
            ...
            {
                Content = new BlobStreamContent(sqlStream, 1048576, cmd)
            };
